...
const JWT_SECRET = 'Raviisniceb$oy';

//ROUTER-1, create a User using :POST "/api/auth/createuser". No login requireed. Doesn't require Auth.
...
router.post('/createuser',[
 ...
 //ROUTER-2,Authenticate a User using :POST "/api/auth/login". No login requireed. 
